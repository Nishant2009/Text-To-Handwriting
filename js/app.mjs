...
/**
 *
 * Hi there! This is the entry file of the tool and deals with adding event listeners and some other functions.
 *
 * To contribute, you can follow the imports above and make changes in the file related to the issue you've choosen.
 *
 * If you have any questions related to code, you can drop them in my email at nishantpratapsavita1@gmail.com
 *
...
fetch(
  'https://api.github.com/repos/nishant2009/text-to-handwriting/contributors'
)
  .then((res) => res.json())
  .then((res) => {
